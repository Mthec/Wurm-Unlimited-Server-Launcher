...
public class ModLoader {
	...
	public List<WurmMod> loadModsFromModDir(Path modDir) throws IOException {
		...
		mods.stream().filter(modEntry -> modEntry.mod instanceof PreInitable).forEach(modEntry -> modEntry.mod.preInit());

		mods.stream().filter(modEntry -> modEntry.mod instanceof Initable).forEach(modEntry -> modEntry.mod.init());
	...
	// TODO - Saving back to mod.properties file?
